...
function createMockClient(options) {
    return {
        leaseTasks: options?.leaseTasks ?? vitest_1.vi.fn().mockResolvedValue([]),
        reportOutcome: options?.reportOutcome ?? vitest_1.vi.fn().mockResolvedValue(undefined),
        heartbeat: options?.heartbeat ?? vitest_1.vi.fn().mockResolvedValue(undefined),
    };
}
function createTask(id, jobId, shard = 0) {
    return {
        id,
        jobId,
        attemptNumber: 1,
...
(0, vitest_1.describe)("SiloWorker", () => {
    ...
    (0, vitest_1.describe)("start and stop", () => {
        ...
        (0, vitest_1.it)("polls for tasks when started", async () => {
            const leaseTasks = vitest_1.vi.fn().mockResolvedValue([]);
    ...
    (0, vitest_1.describe)("heartbeats", () => {
        (0, vitest_1.it)("sends heartbeats while task is executing", async () => {
            ...
            const leaseTasks = vitest_1.vi
                ...
                .mockResolvedValue([]);
            const reportOutcome = vitest_1.vi.fn().mockResolvedValue(undefined);
            const heartbeat = vitest_1.vi.fn().mockResolvedValue(undefined);
            ...
            (0, vitest_1.expect)(heartbeat).toHaveBeenCalledWith("test-worker", "task-hb", 0, undefined);
    ...
    (0, vitest_1.describe)("TaskContext", () => {
        (0, vitest_1.it)("provides abort signal in context", async () => {
