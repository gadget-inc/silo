...
class JsonValueBytes$Type extends runtime_4.MessageType {
    constructor() {
 ...
 */
exports.JsonValueBytes = new JsonValueBytes$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
class EnqueueRequest$Type extends runtime_4.MessageType {
    constructor() {
        super("silo.v1.EnqueueRequest", [
            ...
            { no: 6, name: "payload", kind: "message", T: () => exports.JsonValueBytes },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* silo.v1.JsonValueBytes payload */ 6:
                    message.payload = exports.JsonValueBytes.internalBinaryRead(reader, reader.uint32(), options, message.payload);
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.payload)
            exports.JsonValueBytes.internalBinaryWrite(message.payload, writer.tag(6, runtime_1.WireType.LengthDelimited).fork(), options).join();
...
class JobAttempt$Type extends runtime_4.MessageType {
    constructor() {
        super("silo.v1.JobAttempt", [
            ...
            { no: 7, name: "result", kind: "message", T: () => exports.JsonValueBytes },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional silo.v1.JsonValueBytes result */ 7:
                    message.result = exports.JsonValueBytes.internalBinaryRead(reader, reader.uint32(), options, message.result);
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.result)
            exports.JsonValueBytes.internalBinaryWrite(message.result, writer.tag(7, runtime_1.WireType.LengthDelimited).fork(), options).join();
...
class GetJobResponse$Type extends runtime_4.MessageType {
    constructor() {
        super("silo.v1.GetJobResponse", [
            ...
            { no: 4, name: "payload", kind: "message", T: () => exports.JsonValueBytes },
            { no: 5, name: "retry_policy", kind: "message", T: () => exports.RetryPolicy },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.payload)
            exports.JsonValueBytes.internalBinaryWrite(message.payload, writer.tag(4, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* optional silo.v1.RetryPolicy retry_policy = 5; */
        if (message.retryPolicy)
            exports.RetryPolicy.internalBinaryWrite(message.retryPolicy, writer.tag(5, runtime_1.WireType.LengthDelimited).fork(), options).join();
...
class GetJobResultResponse$Type extends runtime_4.MessageType {
    constructor() {
        super("silo.v1.GetJobResultResponse", [
            ...
            { no: 4, name: "success_data", kind: "message", oneof: "result", T: () => exports.JsonValueBytes },
            ...
            switch (fieldNo) {
                ...
                case /* silo.v1.JsonValueBytes success_data */ 4:
                    message.result = {
                        ...
                        successData: exports.JsonValueBytes.internalBinaryRead(reader, reader.uint32(), options, message.result.successData)
                    };
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.result.oneofKind === "successData")
            exports.JsonValueBytes.internalBinaryWrite(message.result.successData, writer.tag(4, runtime_1.WireType.LengthDelimited).fork(), options).join();
...
class Task$Type extends runtime_4.MessageType {
    constructor() {
        super("silo.v1.Task", [
            ...
            { no: 5, name: "payload", kind: "message", T: () => exports.JsonValueBytes },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.payload)
            exports.JsonValueBytes.internalBinaryWrite(message.payload, writer.tag(5, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* uint32 priority = 6; */
        if (message.priority !== 0)
...
class ReportOutcomeRequest$Type extends runtime_4.MessageType {
    constructor() {
        super("silo.v1.ReportOutcomeRequest", [
            ...
            { no: 3, name: "success", kind: "message", oneof: "outcome", T: () => exports.JsonValueBytes },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* silo.v1.JsonValueBytes success */ 3:
                    message.outcome = {
                        oneofKind: "success",
                        success: exports.JsonValueBytes.internalBinaryRead(reader, reader.uint32(), options, message.outcome.success)
                    };
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.outcome.oneofKind === "success")
            exports.JsonValueBytes.internalBinaryWrite(message.outcome.success, writer.tag(3, runtime_1.WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.tenant !== undefined)
            writer.tag(5, runtime_1.WireType.LengthDelimited).string(message.tenant);
...
class HeartbeatRequest$Type extends runtime_4.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.tenant !== undefined)
            writer.tag(4, runtime_1.WireType.LengthDelimited).string(message.tenant);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class QueryResponse$Type extends runtime_4.MessageType {
    constructor() {
        super("silo.v1.QueryResponse", [
            ...
            { no: 2, name: "rows", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => exports.JsonValueBytes },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated silo.v1.JsonValueBytes rows */ 2:
                    message.rows.push(exports.JsonValueBytes.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.rows.length; i++)
            exports.JsonValueBytes.internalBinaryWrite(message.rows[i], writer.tag(2, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* int32 row_count = 3; */
