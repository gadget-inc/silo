...
exports.ColumnInfo = exports.QueryRequest = exports.QueryParameter = exports.QueryNull = exports.HeartbeatResponse = exports.HeartbeatRequest = exports.ReportRefreshOutcomeResponse = exports.RefreshFailure = exports.RefreshSuccess = exports.ReportRefreshOutcomeRequest = exports.ReportOutcomeResponse = exports.Cancelled = exports.Failure = exports.ReportOutcomeRequest = exports.LeaseTasksResponse = exports.RefreshFloatingLimitTask = exports.Task = exports.LeaseTasksRequest = exports.LeaseTaskResponse = exports.LeaseTaskRequest = exports.ExpediteJobResponse = exports.ExpediteJobRequest = exports.RestartJobResponse = exports.RestartJobRequest = exports.DropTenantHoldersResponse = exports.DropTenantHoldersRequest = exports.CancelJobResponse = exports.CancelJobRequest = exports.DeleteJobResponse = exports.DeleteJobRequest = exports.JobCancelled = exports.JobFailure = exports.GetJobResultResponse = exports.GetJobResultRequest = exports.GetJobResponse = exports.JobAttempt = exports.GetJobRequest = exports.EnqueueResponse = exports.EnqueueRequest = exports.Limit = exports.GubernatorRateLimit = exports.RateLimitRetryPolicy = exports.FloatingConcurrencyLimit = exports.ConcurrencyLimit = exports.RetryPolicy = exports.SerializedBytes = exports.AttemptStatus = exports.JobStatus = exports.GubernatorBehavior = exports.GubernatorAlgorithm = void 0;
exports.Silo = exports.DumpTasksResponse = exports.DumpTasksRequest = exports.GetShardStorageInfoResponse = exports.SortedRunInfo = exports.GetShardStorageInfoRequest = exports.FlushShardResponse = exports.FlushShardRequest = exports.CompactShardResponse = exports.CompactShardRequest = exports.ForceReleaseShardResponse = exports.ForceReleaseShardRequest = exports.ImportJobsResponse = exports.ImportJobResult = exports.ImportJobsRequest = exports.ImportJobRequest = exports.ImportAttempt = exports.ConfigureShardResponse = exports.ConfigureShardRequest = exports.GetNodeInfoResponse = exports.GetNodeInfoRequest = exports.OwnedShardInfo = exports.GetSplitStatusResponse = exports.GetSplitStatusRequest = exports.RequestSplitResponse = exports.RequestSplitRequest = exports.HeapProfileResponse = exports.HeapProfileRequest = exports.CpuProfileResponse = exports.CpuProfileRequest = exports.ResetShardsResponse = exports.ResetShardsRequest = exports.GetClusterInfoResponse = exports.ClusterMember = exports.ShardOwner = exports.GetClusterInfoRequest = exports.ArrowIpcMessage = exports.QueryArrowRequest = exports.QueryResponse = void 0;
...
class GetJobResponse$Type extends runtime_4.MessageType {
    constructor() {
        super("silo.v1.GetJobResponse", [
            ...
            { no: 13, name: "result", kind: "message", T: () => exports.SerializedBytes }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.result)
            exports.SerializedBytes.internalBinaryWrite(message.result, writer.tag(13, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
// @generated message type with reflection information, may provide speed optimized methods
class DropTenantHoldersRequest$Type extends runtime_4.MessageType {
    constructor() {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.tenant !== undefined)
            writer.tag(2, runtime_1.WireType.LengthDelimited).string(message.tenant);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.DropTenantHoldersRequest = new DropTenantHoldersRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class DropTenantHoldersResponse$Type extends runtime_4.MessageType {
    constructor() {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.holdersDropped !== 0n)
            writer.tag(1, runtime_1.WireType.Varint).uint64(message.holdersDropped);
        /* uint64 run_attempts_dropped = 2; */
        if (message.runAttemptsDropped !== 0n)
            writer.tag(2, runtime_1.WireType.Varint).uint64(message.runAttemptsDropped);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.DropTenantHoldersResponse = new DropTenantHoldersResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
class ReportOutcomeRequest$Type extends runtime_4.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.tenantId !== undefined)
            writer.tag(7, runtime_1.WireType.LengthDelimited).string(message.tenantId);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class ReportRefreshOutcomeRequest$Type extends runtime_4.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.tenantId !== undefined)
            writer.tag(6, runtime_1.WireType.LengthDelimited).string(message.tenantId);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class HeartbeatRequest$Type extends runtime_4.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.tenantId !== undefined)
            writer.tag(4, runtime_1.WireType.LengthDelimited).string(message.tenantId);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
// @generated message type with reflection information, may provide speed optimized methods
class QueryNull$Type extends runtime_4.MessageType {
    constructor() {
 ...
 */
exports.QueryNull = new QueryNull$Type();
// @generated message type with reflection information, may provide speed optimized methods
class QueryParameter$Type extends runtime_4.MessageType {
    constructor() {
        super("silo.v1.QueryParameter", [
            ...
            { no: 7, name: "null_value", kind: "message", oneof: "value", T: () => exports.QueryNull }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* silo.v1.QueryNull null_value */ 7:
                    message.value = {
                        oneofKind: "nullValue",
                        nullValue: exports.QueryNull.internalBinaryRead(reader, reader.uint32(), options, message.value.nullValue)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.value.oneofKind === "boolValue")
            writer.tag(1, runtime_1.WireType.Varint).bool(message.value.boolValue);
        /* int64 int64_value = 2; */
        if (message.value.oneofKind === "int64Value")
            writer.tag(2, runtime_1.WireType.Varint).int64(message.value.int64Value);
        /* uint64 uint64_value = 3; */
        if (message.value.oneofKind === "uint64Value")
            writer.tag(3, runtime_1.WireType.Varint).uint64(message.value.uint64Value);
        /* double float64_value = 4; */
        if (message.value.oneofKind === "float64Value")
            writer.tag(4, runtime_1.WireType.Bit64).double(message.value.float64Value);
        /* string string_value = 5; */
        if (message.value.oneofKind === "stringValue")
            writer.tag(5, runtime_1.WireType.LengthDelimited).string(message.value.stringValue);
        /* bytes bytes_value = 6; */
        if (message.value.oneofKind === "bytesValue")
            writer.tag(6, runtime_1.WireType.LengthDelimited).bytes(message.value.bytesValue);
        /* silo.v1.QueryNull null_value = 7; */
        if (message.value.oneofKind === "nullValue")
            exports.QueryNull.internalBinaryWrite(message.value.nullValue, writer.tag(7, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.QueryParameter = new QueryParameter$Type();
// @generated message type with reflection information, may provide speed optimized methods
class QueryRequest$Type extends runtime_4.MessageType {
    constructor() {
        super("silo.v1.QueryRequest", [
            ...
            { no: 3, name: "tenant", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "parameters", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => exports.QueryParameter }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated silo.v1.QueryParameter parameters */ 4:
                    message.parameters.push(exports.QueryParameter.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.parameters.length; i++)
            exports.QueryParameter.internalBinaryWrite(message.parameters[i], writer.tag(4, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
// @generated message type with reflection information, may provide speed optimized methods
class HeapProfileRequest$Type extends runtime_4.MessageType {
    constructor() {
 ...
 */
exports.HeapProfileRequest = new HeapProfileRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class HeapProfileResponse$Type extends runtime_4.MessageType {
    constructor() {
 ...
 */
exports.HeapProfileResponse = new HeapProfileResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
// @generated message type with reflection information, may provide speed optimized methods
class FlushShardRequest$Type extends runtime_4.MessageType {
    constructor() {
 ...
 */
exports.FlushShardRequest = new FlushShardRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class FlushShardResponse$Type extends runtime_4.MessageType {
    constructor() {
 ...
 */
exports.FlushShardResponse = new FlushShardResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetShardStorageInfoRequest$Type extends runtime_4.MessageType {
    constructor() {
 ...
 */
exports.GetShardStorageInfoRequest = new GetShardStorageInfoRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SortedRunInfo$Type extends runtime_4.MessageType {
    constructor() {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.sstCount !== 0n)
            writer.tag(2, runtime_1.WireType.Varint).uint64(message.sstCount);
 ...
 */
exports.SortedRunInfo = new SortedRunInfo$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetShardStorageInfoResponse$Type extends runtime_4.MessageType {
    constructor() {
        super("silo.v1.GetShardStorageInfoResponse", [
            ...
            { no: 5, name: "sorted_runs", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => exports.SortedRunInfo }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated silo.v1.SortedRunInfo sorted_runs */ 5:
                    message.sortedRuns.push(exports.SortedRunInfo.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.l0SstCount !== 0n)
            writer.tag(1, runtime_1.WireType.Varint).uint64(message.l0SstCount);
        /* uint64 total_l0_size = 2; */
        if (message.totalL0Size !== 0n)
            writer.tag(2, runtime_1.WireType.Varint).uint64(message.totalL0Size);
        /* uint64 sorted_run_count = 3; */
        if (message.sortedRunCount !== 0n)
            writer.tag(3, runtime_1.WireType.Varint).uint64(message.sortedRunCount);
        ...
        for (let i = 0; i < message.sortedRuns.length; i++)
            exports.SortedRunInfo.internalBinaryWrite(message.sortedRuns[i], writer.tag(5, runtime_1.WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.GetShardStorageInfoResponse = new GetShardStorageInfoResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class DumpTasksRequest$Type extends runtime_4.MessageType {
    constructor() {
 ...
 */
exports.DumpTasksRequest = new DumpTasksRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class DumpTasksResponse$Type extends runtime_4.MessageType {
    constructor() {
    ...
    internalBinaryWrite(message, writer, options) {
        /* string dump = 1; */
        if (message.dump !== "")
            writer.tag(1, runtime_1.WireType.LengthDelimited).string(message.dump);
        /* uint32 task_count = 2; */
        if (message.taskCount !== 0)
            writer.tag(2, runtime_1.WireType.Varint).uint32(message.taskCount);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.DumpTasksResponse = new DumpTasksResponse$Type();
/**
...
exports.Silo = new runtime_rpc_1.ServiceType("silo.v1.Silo", [
    ...
    { name: "DropTenantHolders", options: {}, I: exports.DropTenantHoldersRequest, O: exports.DropTenantHoldersResponse },
    ...
    { name: "HeapProfile", options: {}, I: exports.HeapProfileRequest, O: exports.HeapProfileResponse },
    ...
    { name: "FlushShard", options: {}, I: exports.FlushShardRequest, O: exports.FlushShardResponse },
    { name: "GetShardStorageInfo", options: {}, I: exports.GetShardStorageInfoRequest, O: exports.GetShardStorageInfoResponse },
    { name: "DumpTasks", options: {}, I: exports.DumpTasksRequest, O: exports.DumpTasksResponse }
]);
