...
exports.Silo = exports.CpuProfileResponse = exports.CpuProfileRequest = exports.ResetShardsResponse = exports.ResetShardsRequest = exports.GetShardCountersResponse = exports.GetShardCountersRequest = void 0;
...
class Task$Type extends runtime_4.MessageType {
    constructor() {
        super("silo.v1.Task", [
            ...
            { no: 5, name: "payload", kind: "message", T: () => exports.SerializedBytes },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.payload)
            exports.SerializedBytes.internalBinaryWrite(message.payload, writer.tag(5, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* uint32 priority = 6; */
        if (message.priority !== 0)
...
// @generated message type with reflection information, may provide speed optimized methods
class GetShardCountersRequest$Type extends runtime_4.MessageType {
    constructor() {
 ...
 */
exports.GetShardCountersRequest = new GetShardCountersRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetShardCountersResponse$Type extends runtime_4.MessageType {
    constructor() {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.totalJobs !== 0n)
            writer.tag(1, runtime_1.WireType.Varint).int64(message.totalJobs);
        /* int64 completed_jobs = 2; */
        if (message.completedJobs !== 0n)
            writer.tag(2, runtime_1.WireType.Varint).int64(message.completedJobs);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.GetShardCountersResponse = new GetShardCountersResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
exports.Silo = new runtime_rpc_1.ServiceType("silo.v1.Silo", [
    ...
    { name: "GetShardCounters", options: {}, I: exports.GetShardCountersRequest, O: exports.GetShardCountersResponse },
