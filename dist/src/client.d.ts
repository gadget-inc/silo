...
import type { MsgpackBytes, QueryResponse, RetryPolicy, Task, ShardOwner } from "./pb/silo";
...
export declare class SiloGRPCClient {
     ...
     * @throws TaskNotFoundError if the task (lease) doesn't exist.
     */
    heartbeat(workerId: string, taskId: string, shard: number): Promise<HeartbeatResult>;
    /**
