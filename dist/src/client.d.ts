...
import type { RetryPolicy, Task, ShardOwner } from "./pb/silo";
 ...
 */
export declare class DuplicateTaskDeliveryError extends Error {
    code: string;
 ...
 */
export declare class SiloGrpcError extends Error {
    code: string;
 ...
 */
export declare class SiloAlreadyExistsError extends SiloGrpcError {
    code: string;
 ...
 */
export declare class SiloNotFoundError extends SiloGrpcError {
    code: string;
    constructor(grpcMessage: string);
}
/**
 ...
 */
export declare class JobAlreadyExistsError extends SiloAlreadyExistsError {
    code: string;
 ...
 */
export declare class SiloInvalidArgumentError extends SiloGrpcError {
    code: string;
    constructor(grpcMessage: string);
}
/**
 ...
 */
export declare class SiloFailedPreconditionError extends SiloGrpcError {
    code: string;
    constructor(grpcMessage: string);
}
/**
 ...
 */
export declare class SiloUnauthenticatedError extends SiloGrpcError {
    code: string;
    constructor(grpcMessage: string);
}
/**
 ...
 */
export declare class SiloPermissionDeniedError extends SiloGrpcError {
    code: string;
    constructor(grpcMessage: string);
}
/**
 ...
 */
export declare class SiloResourceExhaustedError extends SiloGrpcError {
    code: string;
    constructor(grpcMessage: string);
}
/**
 ...
 */
export declare class SiloUnavailableError extends SiloGrpcError {
    code: string;
    constructor(grpcMessage: string);
}
/**
 ...
 */
export declare class SiloDeadlineExceededError extends SiloGrpcError {
    code: string;
    constructor(grpcMessage: string);
}
/**
...
export declare function initHasher(): Promise<void>;
/**
 ...
 */
export declare function hashTenant(tenantId: string): string;
/**
 ...
 */
export declare function shardForTenant(key: string, shards: ShardInfoWithRange[]): ShardInfoWithRange | undefined;
 ...
 */
export declare function isConnectivityError(error: unknown): boolean;
/**
...
export declare class SiloGRPCClient {
    ...
    private readonly _authInterceptor;
    /** @internal */
    private readonly _maxRetries;
    /** @internal */
    private readonly _retryDelayMs;
    /** @internal */
    private readonly _topologyRefreshTimeoutMs;
    ...
    private readonly _wrongShardRetryCounter;
    /**
     ...
     * @internal
     */
    _getClientAtIndex(index: number): SiloClient;
    /**
     ...
     * @internal
     */
    private _withShardRetryForShard;
    /**
     ...
     */
    importJobs(jobs: ImportJobOptions[]): Promise<ImportJobResult[]>;
    /**
     * Get a job by ID.
     * @param id      The job ID.
     ...
     */
    leaseTask(options: LeaseTaskOptions): Promise<Task>;
    /**
     ...
     */
    leaseTasks(options: LeaseTasksOptions, serverIndex?: number): Promise<LeaseTasksResult>;
    /**
     ...
     * @throws TaskNotFoundError if the task (lease) doesn't exist.
     */
    heartbeat(workerId: string, taskId: string, shard: string, tenant?: string): Promise<HeartbeatResult>;
    /**
     ...
     */
    query<Row = Record<string, unknown>>(sql: string, tenant?: string, parameters?: QueryBindParameter[]): Promise<QueryResult<Row>>;
    /**
     ...
     */
    getShardForTenant(tenant: string): string;
    /**
 ...
 */
export declare function encodeBytes(value: unknown): Uint8Array;
/**
 * Decode MessagePack bytes as a value.
 * @param bytes The MessagePack bytes to decode.
 * @returns The decoded value.
 */
export declare function decodeBytes<T = unknown>(bytes: Uint8Array | undefined, field: string): T;
/**
 ...
 */
export declare function tolerantDecodeAttemptBytes<T = unknown>(bytes: Uint8Array | undefined, _field: string): T | undefined;
