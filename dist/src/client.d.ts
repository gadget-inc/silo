...
export declare class SiloGRPCClient {
     ...
     */
    getJob(id: string, tenant?: string): Promise<Job | undefined>;
    /**
     * Delete a job by ID.
     * @param id     The job ID.
     * @param tenant Tenant ID for routing to the correct shard. Uses default tenant if not provided.
     ...
     */
    leaseTasks(options: LeaseTasksOptions): Promise<Task[]>;
    /**
     ...
     */
    heartbeat(workerId: string, taskId: string, shard: number, tenant?: string): Promise<void>;
    /**
