...
// Restart Job Tests
// =============================================================================
// These tests verify the restart functionality per Alloy spec:
...
/// [SILO-RESTART-1][SILO-RESTART-4][SILO-RESTART-5][SILO-RESTART-6]
/// Restart a cancelled scheduled job - clears cancellation and creates new task
#[silo::test]
...
/// [SILO-EXP-1][SILO-EXP-4][SILO-EXP-5] Expedite a future-scheduled job to run immediately
#[silo::test]
