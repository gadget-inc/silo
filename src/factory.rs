            ...
            .get_or_try_init(|| async {
                ...
                let shard_arc = JobStoreShard::open_with_resolved_store(
                    ...
                    OpenShardOptions {
                        ...
                        orphan_holder_sweep_slice: template.orphan_holder_sweep_slice,
                        orphan_holder_grace_ms: template.orphan_holder_grace_ms,
                        orphan_holder_stale_ms: template.orphan_holder_stale_ms,
    ...
    async fn open_closed_shard_raw(
        ...
        let shard = JobStoreShard::open_with_resolved_store(
            ...
            OpenShardOptions {
                ...
                orphan_holder_sweep_slice: self.template.orphan_holder_sweep_slice,
                orphan_holder_grace_ms: self.template.orphan_holder_grace_ms,
                orphan_holder_stale_ms: self.template.orphan_holder_stale_ms,
