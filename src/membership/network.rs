...
use openraft::{AnyError, RaftNetworkFactory};
...
use crate::membershippb::VoteRequest as PbVoteRequest;
use crate::membershippb::VoteResponse as PbVoteResponse;
...
impl RaftNetworkFactory<TypeConfig> for Network {
    ...
    async fn new_client(&mut self, _: NodeId, node: &pb::Node) -> Self::Network {
